...
new_roots_raw = [
    ...
    {"id": 241, "root": "footing", "phonetic": "/ˈfʊtɪŋ/", "pos": "名词", "meaning": "基础；基脚", "mnemonic": "Footing→foot(脚)+ing→基础", "phrases": ["spread footing 扩展基础", "isolated footing 独立基础", "combined footing 联合基础", "strip footing 条形基础"]},
    {"id": 242, "root": "raft", "phonetic": "/rɑːft/", "pos": "名词", "meaning": "筏板", "mnemonic": "Raft→筏子→筏板基础", "phrases": ["raft foundation 筏板基础", "mat foundation 满堂基础", "raft slab 筏板", "buoyant raft 浮筏基础"]},
    {"id": 243, "root": "caisson", "phonetic": "/ˈkeɪsən/", "pos": "名词", "meaning": "沉箱", "mnemonic": "Caisson→音似\"凯森\"→凯森沉箱", "phrases": ["pneumatic caisson 气压沉箱", "open caisson 开口沉箱", "caisson foundation 沉箱基础", "caisson disease 沉箱病"]},
    {"id": 244, "root": "micropile", "phonetic": "/ˈmaɪkrəʊpaɪl/", "pos": "名词", "meaning": "微型桩", "mnemonic": "Micropile→micro(微)+pile(桩)→微型桩", "phrases": ["micropile foundation 微型桩基础", "micropile group 微型桩群", "root pile 树根桩", "micropile installation 微型桩施工"]},
    {"id": 245, "root": "compensated", "phonetic": "/ˈkɒmpenseɪtɪd/", "pos": "形容词", "meaning": "补偿的", "mnemonic": "Compensated→compensate(补偿)+d→补偿的", "phrases": ["compensated foundation 补偿基础", "fully compensated foundation 全补偿基础", "compensated raft 补偿筏板", "compensation grouting 补偿注浆"]},
    {"id": 246, "root": "floating", "phonetic": "/ˈfləʊtɪŋ/", "pos": "形容词", "meaning": "浮式的", "mnemonic": "Floating→float(漂浮)+ing→浮式的", "phrases": ["floating foundation 浮式基础", "floating slab 浮板", "floating structure 浮动结构", "semi-floating foundation 半浮式基础"]},
    {"id": 247, "root": "pilecap", "phonetic": "/paɪl kæp/", "pos": "名词", "meaning": "承台", "mnemonic": "Pilecap→pile(桩)+cap(帽)→桩帽承台", "phrases": ["pile cap 承台", "pile cap beam 承台梁", "group pile cap 群桩承台", "pile cap design 承台设计"]},
    {"id": 248, "root": "pileshaft", "phonetic": "/paɪl ʃɑːft/", "pos": "名词", "meaning": "桩身", "mnemonic": "Pileshaft→pile(桩)+shaft(杆)→桩身", "phrases": ["pile shaft 桩身", "shaft resistance 桩侧阻力", "pile shaft concrete 桩身混凝土", "enlarged pile shaft 扩底桩身"]},
    {"id": 249, "root": "piletoe", "phonetic": "/paɪl təʊ/", "pos": "名词", "meaning": "桩端", "mnemonic": "Piletoe→pile(桩)+toe(脚尖)→桩端", "phrases": ["pile toe 桩端", "toe resistance 端阻力", "pile toe bearing 桩端承载", "enlarged pile toe 扩底桩端"]},
    {"id": 250, "root": "underreamed", "phonetic": "/ˌʌndəˈriːmd/", "pos": "形容词", "meaning": "扩底的", "mnemonic": "Underreamed→under(下)+ream(扩孔)+ed→扩底的", "phrases": ["underreamed pile 扩底桩", "underreamed base 扩底基础", "underreaming 扩底施工", "underreamed caisson 扩底沉箱"]},
    {"id": 251, "root": "mat", "phonetic": "/mæt/", "pos": "名词", "meaning": "满堂基础", "mnemonic": "Mat→垫子→满堂基础如垫子", "phrases": ["mat foundation 满堂基础", "flat mat 平板式满堂基础", "cellular mat 格构式满堂基础", "rigid mat 刚性满堂基础"]},
    {"id": 252, "root": "pier", "phonetic": "/pɪər/", "pos": "名词", "meaning": "墩；码头", "mnemonic": "Pier→码头→桥墩", "phrases": ["bridge pier 桥墩", "pier foundation 墩基础", "pier cap 墩帽", "solid pier 实体墩"]},
    {"id": 253, "root": "abutment", "phonetic": "/əˈbʌtmənt/", "pos": "名词", "meaning": "桥台", "mnemonic": "Abutment→abut(邻接)+ment→邻接桥跨的构造→桥台", "phrases": ["abutment wall 桥台墙", "wing wall 翼墙", "abutment foundation 桥台基础", "abutment seat 桥台支座"]},
    {"id": 254, "root": "stemwall", "phonetic": "/stem wɔːl/", "pos": "名词", "meaning": "墙式基础", "mnemonic": "Stemwall→stem(茎)+wall(墙)→墙式基础", "phrases": ["stem wall 墙式基础", "foundation stem wall 基础墙", "stem wall footing 墙式基础基脚", "concrete stem wall 混凝土墙式基础"]},
    {"id": 255, "root": "gradebeam", "phonetic": "/ɡreɪd biːm/", "pos": "名词", "meaning": "地梁", "mnemonic": "Gradebeam→grade(地面)+beam(梁)→地梁", "phrases": ["grade beam 地梁", "foundation grade beam 基础地梁", "concrete grade beam 混凝土地梁", "grade beam foundation 地梁基础"]},
    {"id": 256, "root": "piledriver", "phonetic": "/paɪl ˈdraɪvə/", "pos": "名词", "meaning": "打桩机", "mnemonic": "Piledriver→pile(桩)+driver(驱动器)→打桩机", "phrases": ["pile driver 打桩机", "hydraulic pile driver 液压打桩机", "diesel pile driver 柴油打桩机", "pile driver hammer 打桩锤"]},
    {"id": 257, "root": "auger", "phonetic": "/ˈɔːɡə/", "pos": "名词", "meaning": "螺旋钻", "mnemonic": "Auger→音似\"奥格\"→螺旋钻", "phrases": ["auger pile 螺旋钻孔桩", "auger boring 螺旋钻探", "continuous flight auger 连续螺旋钻", "auger cast pile 螺旋灌注桩"]},
    {"id": 258, "root": "vibroflot", "phonetic": "/ˈvaɪbrəʊflɒt/", "pos": "名词", "meaning": "振冲器", "mnemonic": "Vibroflot→vibro(振动)+float(浮)→振冲器", "phrases": ["vibroflotation 振冲法", "vibroflot stone column 振冲碎石桩", "vibro replacement 振冲置换", "vibro compaction 振冲密实"]},
    {"id": 259, "root": "geogrid", "phonetic": "/ˈdʒiːəʊɡrɪd/", "pos": "名词", "meaning": "土工格栅", "mnemonic": "Geogrid→geo(土)+grid(网格)→土工格栅", "phrases": ["geogrid reinforcement 土工格栅加筋", "biaxial geogrid 双向土工格栅", "geogrid base 格栅基础", "geogrid mattress 格栅垫层"]},
    {"id": 260, "root": "geotextile", "phonetic": "/ˈdʒiːəʊtekstaɪl/", "pos": "名词", "meaning": "土工织物", "mnemonic": "Geotextile→geo(土)+textile(织物)→土工织物", "phrases": ["geotextile filter 土工织物滤层", "woven geotextile 编织土工布", "non-woven geotextile 无纺土工布", "geotextile separator 土工织物隔离层"]},
]
